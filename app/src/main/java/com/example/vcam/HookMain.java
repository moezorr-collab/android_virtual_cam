    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam lpparam) throws Exception {
        XposedHelpers.findAndHookMethod("android.hardware.Camera", lpparam.classLoader, "setPreviewTexture", SurfaceTexture.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) {
                File file = new File(video_path + "virtual.bmp");
                if (file.exists()) {
                    ...
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("1【VCAM】[toast]" + ee.toString());
                        }
                    }
                }
            }
                ...
                if (!file.exists()) {
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("2【VCAM】[toast]" + ee.toString());
                        }
                    }
                    return;
                }
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                if (toast_content != null && need_to_show_toast) {
                    try {
                        ...
                        XposedBridge.log("4【VCAM】[toast]" + Arrays.toString(ee.getStackTrace()));
                    }
                }
            }
        });
        ...
        XposedHelpers.findAndHookMethod("android.hardware.Camera", lpparam.classLoader, "startPreview", new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                if (!file.exists()) {
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("5【VCAM】[toast]" + ee.toString());
                        }
                    }
                    return;
                }
                ...
                if (ori_holder != null) {
                    ...
                    try {
                        mplayer1.setDataSource(video_path + "virtual.bmp");
                        mplayer1.prepare();
                    } catch (IOException e) {
                ...
                if (mSurfacetexture != null) {
                    ...
                    try {
                        mMediaPlayer.setDataSource(video_path + "virtual.bmp");
                ...
                if (!file.exists()) {
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("6【VCAM】[toast]" + ee.toString());
                        }
                    }
                    return;
                }
                ...
                if (!file.exists()) {
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("8【VCAM】[toast]" + ee.toString());
                        }
                    }
                    return;
                }
...
/*        XposedHelpers.findAndHookMethod("android.hardware.Camera", lpparam.classLoader, "stopPreview", new XC_MethodHook() {
        ...
        XposedHelpers.findAndHookMethod("android.media.ImageReader", lpparam.classLoader, "newInstance", int.class, int.class, int.class, int.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) {
                ...
                if (toast_content != null && need_to_show_toast) {
                    try {
                        Toast.makeText(toast_content, "应用创建了渲染器 newInstance：\n宽：" + param.args[0] + "\n高：" + param.args[1] + "\n一般只需要宽高比与视频相同", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        XposedBridge.log("10【VCAM】[toast]" + e.toString());
                    }
                }
            }
        });
    ...
    private void process_camera2_play() {
        ...
        if (c2_reader_Surfcae != null) {
            ...
            try {
                ...
                c2_hw_decode_obj.decode(video_path + "virtual.bmp");
        ...
        if (c2_reader_Surfcae_1 != null) {
            ...
            try {
                ...
                c2_hw_decode_obj_1.decode(video_path + "virtual.bmp");
            } catch (Throwable throwable) {
                XposedBridge.log("【VCAM】" + throwable);
            }
        }
        ...
        if (c2_preview_Surfcae != null) {
            ...
            try {
                ...
                c2_player.setDataSource(video_path + "virtual.bmp");
                c2_player.prepare();
            } catch (Exception e) {
        ...
        if (c2_preview_Surfcae_1 != null) {
            ...
            try {
                ...
                c2_player_1.setDataSource(video_path + "virtual.bmp");
                c2_player_1.prepare();
            } catch (Exception e) {
                ...
                if (!file.exists()) {
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            ...
                            XposedBridge.log("11【VCAM】[toast]" + ee.toString());
                        }
                    }
                    return;
                }
        ...
        XposedHelpers.findAndHookMethod(callback, "onPictureTaken", byte[].class, android.hardware.Camera.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam paramd) throws Throwable {
                try {
                    ...
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            Toast.makeText(toast_content, "发现拍照 onPictureTaken\n宽：" + onemwidth + "\n高：" + onemhight + "\n格式：JPEG", Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            XposedBridge.log("12【VCAM】[toast]" + e.toString());
                        }
                    }
                    File control_file = new File(Environment.getExternalStorageDirectory().getPath() + "/DCIM/Camera1/" + "disable.jpg");
                    if (control_file.exists()) {
        ...
        XposedHelpers.findAndHookMethod(callback, "onPictureTaken", byte[].class, android.hardware.Camera.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam paramd) throws Throwable {
                try {
                    ...
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            Toast.makeText(toast_content, "发现拍照 onPictureTaken2\n宽：" + onemwidth + "\n高：" + onemhight + "\n格式：YUV_420_888", Toast.LENGTH_SHORT).show();
                        } catch (Exception ee) {
                            XposedBridge.log("13【VCAM】[toast]" + ee.toString());
                        }
                    }
                    File control_file = new File(Environment.getExternalStorageDirectory().getPath() + "/DCIM/Camera1/" + "disable.jpg");
                    if (control_file.exists()) {
        ...
        if (!file.exists()) {
            if (toast_content != null && need_to_show_toast) {
                try {
                    ...
                    XposedBridge.log("14【VCAM】[toast]" + ee);
                }
            }
            need_stop = 1;
        }
        ...
        XposedHelpers.findAndHookMethod(preview_cb_class, "onPreviewFrame", byte[].class, android.hardware.Camera.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam paramd) throws Throwable {
                ...
                if (localcam.equals(camera_onPreviewFrame)) {
                    ...
                    if (toast_content != null && need_to_show_toast) {
                        try {
                            Toast.makeText(toast_content, "发现预览 onPreviewFrame\n宽：" + mwidth + "\n高：" + mhight + "\n" + "需要视频分辨率与其完全相同", Toast.LENGTH_SHORT).show();
                        } catch (Exception ee) {
                            XposedBridge.log("15【VCAM】[toast]" + ee.toString());
                        }
                    }
                    if (finalNeed_stop == 1) {
                        return;
                    ...
                    hw_decode_obj.decode(video_path + "virtual.bmp");
                    while (data_buffer == null) {
                    }
                    System.arraycopy(data_buffer, 0, paramd.args[0], 0, Math.min(data_buffer.length, ((byte[]) paramd.args[0]).length));
                }
